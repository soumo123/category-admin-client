...
export const CANCEL_ORDER_CONSTANT = 'CANCEL_ORDER_CONSTANT';
...
export const STATUS_ORDER_SUCCESS = 'STATUS_ORDER_SUCCESS';
export const STATUS_ORDER_FAIL = 'STATUS_ORDER_FAIL';
